...
Partial Public Class Inventario
  ...
  Private mPardet_EstadoInventario As Integer = 0
    ...
    Private mInvent_SolicitarConfirmacion As Boolean = False
  ...
  End Property
    ...
    <XmlAttribute()> _
    Public Overridable Property Invent_SolicitarConfirmacion() As Boolean
        Get
            Return Me.mInvent_SolicitarConfirmacion
        End Get
        Set(value As Boolean)
            Me.mInvent_SolicitarConfirmacion = value
            EsModificado = True
        End Set
    End Property
