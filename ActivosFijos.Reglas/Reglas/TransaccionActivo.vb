...
#End Region
    ...
    Public Overridable Function Guardar(_Custodio As Empleado, _SolicitarConfirmacionNuevoCustodio As Boolean, _Ubicacion As WWTSParametroDet, _Restriccion As Infoware.Reglas.General.Restriccion) As Boolean
        ...
        If bReturn Then
            If EsNuevo Then
                ...
                Dim _custodioAnterior As Empleado
                Dim _ubicacionAnterior As WWTSParametroDet
                If _Custodio IsNot Nothing Then
                    For Each _activo As Activo In Activos
                        ...
                        _custodioAnterior = _activo.CustodioActual
                        ...
                        Else
                            Infoware.Reglas.General.Auditoria.Registrar_Auditoria(_Restriccion, Enumerados.enumTipoAccion.Adicion,
                                                                                  "(" + Transa_Codigo.ToString + ") Cambio de custodio " + _activo.Activo_CodigoBarra + " " + _activo.Descripcion +
                                                                                  " Custodio anterior: " + _custodioAnterior.NombreCompleto + ", Custodio actual: " + _Custodio.NombreCompleto)
                        End If
                    Next
                End If
                ...
                If _Ubicacion IsNot Nothing Then
                    For Each _activo As Activo In Activos
                        ...
                        _ubicacionAnterior = _activo.UbicacionActual
                        ...
                        Else
                            Infoware.Reglas.General.Auditoria.Registrar_Auditoria(_Restriccion, Enumerados.enumTipoAccion.Adicion,
                                                                                  "(" + Transa_Codigo.ToString + ") Cambio de ubicación " + _activo.Activo_CodigoBarra + " " + _activo.Descripcion +
                                                                                  " Ubicación anterior: " + _ubicacionAnterior.DescripcionLarga + ", Ubicación actual: " + _Ubicacion.DescripcionLarga)
                        End If
                    Next
                End If
            End If
