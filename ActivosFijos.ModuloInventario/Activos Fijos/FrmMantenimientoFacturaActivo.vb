...
#Region "Parametros"
    ...
    Sub llenar_datos()
        ...
        If mFacturaActivo.PardetAdjuntoArchivos Is Nothing Then
            mFacturaActivo.PardetAdjuntoArchivos = New WWTSParametroDet(FacturaActivo.OperadorDatos, Enumerados.EnumParametros.Adjuntos, True)
        End If
        Me.CtlAdjunto1.ParameAdjunto = mFacturaActivo.PardetAdjuntoArchivos
...
#Region "Guardar y Eliminar"
    ...
    Private Sub Mapear_Datos()
        ...
        mFacturaActivo.PardetAdjuntoArchivos = Me.CtlAdjunto1.ParameAdjunto
    End Sub
