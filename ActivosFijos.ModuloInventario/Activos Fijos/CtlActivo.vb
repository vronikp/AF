...
Public Class CtlActivo
  ...
  Private mParametroDepreciacion As WWTSParametroDet
...
#End Region
  ...
  Private Sub CargarCombos()
    ...
    If mParametroDepreciacion.Pardet_DatoStr1.ToUpper() = "MENSUAL" Then
      cboFrecuenciaDepreciacion.SelectedIndex = 0
    Else
      cboFrecuenciaDepreciacion.SelectedIndex = 1
    End If
...
#End Region
  ...
  Private Sub actualizarValoracionInicial()
    If Me.mActivo Is Nothing Or Me.cboestadodepreciacion.ParametroDet Is Nothing Then
      Exit Sub
    End If
    If Me.cboestadodepreciacion.ParametroDet.Pardet_Secuencia = 2 Or txtcostoactivo.Value = 0 Then
      Me.txtvalorsalvamento.Value = 0
      Me.txtvaloradepreciar.Value = 0
      Me.txtperiodosdepreciables.Value = 0
    Else
      If Me.mParametroDepreciacion.Pardet_DatoStr2.ToUpper() = "FIJO" Then
        Me.txtvalorsalvamento.Value = Convert.ToDouble(Me.mParametroDepreciacion.Pardet_DatoDec1)
      Else
        Me.txtvalorsalvamento.Value = Convert.ToDouble(Me.mParametroDepreciacion.Pardet_DatoDec1) * Me.txtcostoactivo.Value
      End If
  ...
  Private Sub txtcostoactivo_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtcostoactivo.TextChanged
    Me.actualizarValoracionInicial()
  End Sub

  Private Sub txtvalorsalvamento_TextChanged(sender As System.Object, e As System.EventArgs) Handles txtvalorsalvamento.TextChanged
    Me.txtvaloradepreciar.Value = Me.txtcostoactivo.Value - Me.txtvalorsalvamento.Value
  End Sub
