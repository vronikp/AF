...
Public Class crpActaRecepcionFormato4
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crpActaRecepcionFormato4.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ActivosFijos.ModuloInventario.crpActaRecepcionFormato4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpActaRecepcionFormato4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpActaRecepcionFormato4 = New crpActaRecepcionFormato4()
        rpt.Site = Me.Site
        Return rpt
    End Function
