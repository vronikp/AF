...
Public Class FrmReporteTransaccionBaja
    ...
    Sub llenar_datos()
        Try
            ...
            info.DataDefinition.FormulaFields("Usuario").Text = String.Format("'{0}'", mTransaccionBaja.OperadorDatos.Usuario)
            info.SetDataSource(clsReporteActivo.RetornarActaBajaDS(mTransaccionBaja))
