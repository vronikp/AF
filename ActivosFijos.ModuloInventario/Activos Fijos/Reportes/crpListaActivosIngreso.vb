...
Public Class crpListaActivosIngreso
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crpListaActivosIngreso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpListaActivosIngreso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpListaActivosIngreso = New crpListaActivosIngreso()
        rpt.Site = Me.Site
        Return rpt
    End Function
