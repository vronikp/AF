...
/****** Object:  View [dbo].[vw_DepreciacionDetMensual]    Script Date: 04/11/2018 06:45:19 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vw_DepreciacionDetMensual]
AS
SELECT     TOP (100) PERCENT act.Activo_CodigoBarra AS CodigoBarras, pdTipo.Pardet_Descripcion AS Tipo, pdClase.Pardet_Descripcion AS Clase, dd.Deprec_Ubicacion, 
                      ...
                      dd.Deprec_DepreciacionAcumulada - dd.Deprec_Valor AS DepreciacionAcumuladaAnt,
                          (SELECT     SUM(Deprec_Valor) AS Expr1
                            ...
                            WHERE      (Activo_Codigo = act.Activo_Codigo) AND (Pardet_TipoDepreciacion = dd.Pardet_TipoDepreciacion) AND (Deprec_Codigo BETWEEN LEFT(dd.Deprec_Codigo, 4) * 100 + 1 AND 
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         Or = 1350
      End
   ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_DepreciacionDetMensual'
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_DepreciacionDetMensual'
GO
