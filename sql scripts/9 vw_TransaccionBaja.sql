...
/****** Object:  View [dbo].[vw_TransaccionBaja]    Script Date: 03/09/2018 07:04:30 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[vw_TransaccionBaja]
AS
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_TransaccionBaja'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_TransaccionBaja'
GO
