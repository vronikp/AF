...
#Region "New"
  ...
  Private Sub FrmMantenimientoActivo_Inicializar(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Inicializar
    ...
    Me.ComboBox1.Items.Add("Custodio")
    Me.ComboBox1.Items.Add("Auditoria")
  ...
  Private Sub btnGenerarPlantilla_Click(sender As System.Object, e As System.EventArgs) Handles btnGenerarPlantillaact.Click
    Select Case Me.ComboBox1.SelectedIndex
      ...
      Case 3
        ...
        GenerarExcelActivos(datos)
      Case 4
        Dim datos As New PlantillaCambioCustodioList
        datos.Add(New PlantillaCambioCustodio(Sistema.OperadorDatos))
        GenerarExcelActivos(datos)
      Case 5
        mInventario = New Inventario(Sistema.OperadorDatos, Me.cboInventario.ParametroDet.Parame_Codigo, Me.cboInventario.ParametroDet.Pardet_Secuencia, Me.cboPeriodoInventario.ParametroDet.Parame_Codigo, Me.cboPeriodoInventario.ParametroDet.Pardet_Secuencia)
        Dim datos As PlantillaAuditoriaList = PlantillaAuditoriaList.ObtenerLista(mInventario)
        GenerarExcelActivos(datos)
    End Select
  End Sub
...
#Region "Generar"
  Sub GenerarExcelActivos(datos As IList)
    Try
      ...
      Select Case Me.ComboBox1.SelectedIndex
        Case 0
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Impresion, "Generó plantilla de Carga en Lote de Activos")
        Case 1
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Impresion, "Generó plantilla de Carga en Lote de Valoración")
        Case 2
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Impresion, "Generó plantilla de Carga en Lote de Características")
        Case 3
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Impresion, "Generó plantilla de Carga en Lote de Inventario " + cboPeriodoInventario.ParametroDet.Descripcion +
                                        " " + cboInventario.ParametroDet.Descripcion)
        Case 4
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Impresion, "Generó plantilla de Carga en Lote de Custodio")
        Case 3
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Impresion, "Generó plantilla de Carga en Lote de Auditoría " + cboPeriodoInventario.ParametroDet.Descripcion +
                                        " " + cboInventario.ParametroDet.Descripcion)
      End Select
...
#Region "Cargar"
      ...
      With excelWorksheet
        ...
        While Not CStr(.Cells(fila, 2).value) = ""
          ...
          Try
            ...
            _plantilla.CodigoAux = .Cells(fila, 3).value
            _plantilla.Serie = .Cells(fila, 4).value
            '_plantilla.Grupo = .Cells(fila, 4).value
            '_plantilla.Tipo = .Cells(fila, 5).value
            _plantilla.Clase = .Cells(fila, 5).value
            _plantilla.Descripcion = .Cells(fila, 6).value
            _plantilla.Marca = .Cells(fila, 7).value
            _plantilla.Modelo = .Cells(fila, 8).value
            _plantilla.Observacion = .Cells(fila, 9).value
            _plantilla.EstadoDepreciacion = .Cells(fila, 10).value
            _plantilla.EstadoActivo = .Cells(fila, 11).value
            _plantilla.ResponsableMantenimiento = .Cells(fila, 12).value
            _plantilla.FechaIngreso = CDate(.Cells(fila, 13).value)
            _plantilla.FechaCompra = CDate(.Cells(fila, 14).value)
            _plantilla.FechaUso = CDate(.Cells(fila, 15).value)
            If Not String.IsNullOrWhiteSpace(.Cells(fila, 16).value) Then
              _plantilla.FechaBaja = CDate(.Cells(fila, 16).value)
            Else
              _plantilla.FechaBaja = Nothing
            End If
            _plantilla.Ubicacion = .Cells(fila, 17).value
            _plantilla.CentroCostos = .Cells(fila, 18).value
            _plantilla.Custodio = .Cells(fila, 19).value
            _plantilla.Costo = CDec(.Cells(fila, 20).value)
            _plantilla.Salvamento = CDec(.Cells(fila, 21).value)
            _plantilla.PeriodosDepreciablesMeses = CInt(.Cells(fila, 22).value)
            _plantilla.FrecuenciaDepreciacion = .Cells(fila, 23).value
            _plantilla.Proveedor = .Cells(fila, 24).value
            _plantilla.Factura = .Cells(fila, 25).value
            _plantilla.TipoBajaActivo = .Cells(fila, 26).value
            _plantilla.Caracteristicas = .Cells(fila, 27).value
            _plantilla.FechaCambioUbcacionCustodio = .Cells(fila, 28).value
            _plantilla.Forzar = .Cells(fila, 29).value.ToString.Trim.ToUpper = "SI"
        ...
        If counterrorcarga = 0 And counterroresvalidacion = 0 Then
          ...
          For Each _plantilla As PlantillaActivo In _lote
            ...
            Else
              fila += 1
              Me.lbl_registro.Text = String.Format("{0} registros guardados", (fila).ToString)
              Application.DoEvents()
            End If
          Next
          ...
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Adicion,
                            "Cargó la plantilla de Carga en Lote Activos " + fila.ToString + " registros guardados, " +
                            _loteerror.Count.ToString + "errores.")
    ...
    Try
      ...
      With excelWorksheet
        ...
        If counterrorcarga = 0 And counterroresvalidacion = 0 Then
          ...
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Adicion,
                            "Cargó la plantilla de Carga en Lote Valoración " + fila.ToString + " registros guardados, " +
                            _loteerror.Count.ToString + "errores.")
    ...
    Try
      ...
      With excelWorksheet
        ...
        If counterrorcarga = 0 And counterroresvalidacion = 0 Then
          ...
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Adicion,
                            "Cargó la plantilla de Carga en Lote Características " + fila.ToString + " registros guardados, " +
                            _loteerror.Count.ToString + "errores.")
    ...
    Try
      ...
      With excelWorksheet
        ...
        If counterrorcarga = 0 And counterroresvalidacion = 0 Then
          ...
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Adicion,
                            "Cargó la plantilla de Carga en Lote Inventario " + fila.ToString + " registros guardados, " +
                            _loteerror.Count.ToString + "errores.")
  ...
  Private Sub CargarExcelCustodio()
    Dim ArchivoPlantilla As String = ""
    OpenFileDialog1.FileName = ""
    OpenFileDialog1.Filter = "Archivo Microsoft Excel (*.xls; *.xlsx)|*.xls; *.xlsx|Todos los archivos (*.*)|*.*"
    OpenFileDialog1.FilterIndex = 1
    ...
    Try
      Dim _lote As New PlantillaCambioCustodioList
      ...
      With excelWorksheet
        ...
        Dim fila As Integer = 2
        While Not .Cells(fila, 2).value = ""
          Dim _plantilla As New PlantillaCambioCustodio(Sistema.OperadorDatos)
          Try
            Me.lbl_registro.Text = String.Format("{0} registros leidos", (fila - 1).ToString)
            Application.DoEvents()

            _plantilla.CodigoBarras = .Cells(fila, 2).value
            _plantilla.Custodio = .Cells(fila, 3).value
            _plantilla.CustodioNuevo = .Cells(fila, 4).value
            _plantilla.FechaCambio = CDate(.Cells(fila, 5).value)
            _plantilla.Usuario = Restriccion.Usuario.Usuari_Codigo
        ...
        If counterrorcarga = 0 And counterroresvalidacion = 0 Then
          Dim _loteerror As New PlantillaCambioCustodioList
          fila = 0
          For Each _plantilla As PlantillaCambioCustodio In _lote
            If Not _plantilla.Guardar() Then
              _loteerror.Add(_plantilla)
            Else
              fila += 1
          ...
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Adicion,
                            "Cargó la plantilla de Carga en Lote Custodio " + fila.ToString + " registros guardados, " +
                            _loteerror.Count.ToString + "errores.")
  ...
  Private Sub CargarExcelAuditoria()
    Dim ArchivoPlantilla As String = ""
    OpenFileDialog1.FileName = ""
    OpenFileDialog1.Filter = "Archivo Microsoft Excel (*.xls; *.xlsx)|*.xls; *.xlsx|Todos los archivos (*.*)|*.*"
    OpenFileDialog1.FilterIndex = 1
    ...
    Try
      Dim _lote As New PlantillaAuditoriaList
      ...
      With excelWorksheet
        ...
        Dim fila As Integer = 2
        While Not CStr(.Cells(fila, 2).value) = ""
          Dim _plantilla As New PlantillaAuditoria(Sistema.OperadorDatos)
          Try
            Me.lbl_registro.Text = String.Format("{0} registros leidos", (fila).ToString)
            Application.DoEvents()

            _plantilla.Ubicacion = .Cells(fila, 2).value
            _plantilla.PeriodoInventario = .Cells(fila, 3).value
            _plantilla.UbicacionActual = .Cells(fila, 4).value
            _plantilla.CustodioActual = .Cells(fila, 5).value
            _plantilla.EstadoInventarioDet = .Cells(fila, 6).value
            _plantilla.Usuari_CodigoPDA = .Cells(fila, 7).value
            _plantilla.CodigoBarras = .Cells(fila, 8).value
            _plantilla.EstadoActivo = .Cells(fila, 9).value
            _plantilla.FechaRegistro = .Cells(fila, 10).value
        ...
        If counterrorcarga = 0 And counterroresvalidacion = 0 Then
          Dim _loteerror As New PlantillaAuditoriaList
          fila = 0
          For Each _plantilla As PlantillaAuditoria In _lote
            If Not _plantilla.Guardar() Then
              _loteerror.Add(_plantilla)
            Else
              fila += 1
          ...
          Auditoria.Registrar_Auditoria(Restriccion, Auditoria.enumTipoAccion.Adicion,
                            "Cargó la plantilla de Carga en Lote Auditoría " + fila.ToString + " registros guardados, " +
                            _loteerror.Count.ToString + "errores.")
...
#End Region
  ...
  Private Sub ComboBox1_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        If Me.ComboBox1.SelectedIndex = 3 Or ComboBox1.SelectedIndex = 5 Then
            Me.pnlinventario.Visible = True
        Else
            Me.pnlinventario.Visible = False
        End If

        Me.gbXml.Visible = Me.ComboBox1.SelectedIndex = 5
    End Sub
  ...
  Private Sub btnGenerarXml_Click(sender As System.Object, e As System.EventArgs) Handles btnGenerarXml.Click
    ...
    Try
      ...
      saveFileDialog1.Title = "Guardar la carga para PDA"
      ...
      If saveFileDialog1.FileName <> "" Then
        ...
        Dim datos As Xml.XmlDocument = PlantillaAuditoriaList.ObtenerXml(mInventario)
        Me.ProgressBar2.Value = 3
        datos.Save(saveFileDialog1.FileName)
        Me.ProgressBar2.Value = 4
        MsgBox("Archivo exportado con exito")
      Else
        MsgBox("El nombre del archivo es obligatorio. No se pudo exportar el archivo.")
      End If
