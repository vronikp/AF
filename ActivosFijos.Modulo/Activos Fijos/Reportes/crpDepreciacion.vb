...
Public Class crpDepreciacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ActivosFijos.Modulo.crpDepreciacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpDepreciacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpDepreciacion = New crpDepreciacion()
        rpt.Site = Me.Site
        Return rpt
    End Function
