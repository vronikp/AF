...
Public Class FrmReporteIngresoActivos
    Private mdsReporteActivos As dsReporteActivosIngreso
    Public Property dsReporteActivos As dsReporteActivosIngreso
        Get
            Return mdsReporteActivos
        End Get
        Set(value As dsReporteActivosIngreso)
    ...
    Sub llenar_datos()
        Try
            ...
            info = New crpListaActivosIngreso
