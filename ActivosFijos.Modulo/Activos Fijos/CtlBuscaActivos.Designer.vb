...
Partial Class CtlBuscaActivos
    ...
    Private Sub InitializeComponent()
        ...
        Me.cbotipofecha.Items.AddRange(New Object() {"Compra entre", "Inicio depreciacion entre", "Uso entre", "Baja entre", "Fin de garantia entre", "Sin fecha de uso", "Con fecha de baja", "Sin garantia"})
