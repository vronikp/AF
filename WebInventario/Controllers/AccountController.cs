...
namespace WebInventario.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        ServiceReference1.ActivosFijosServiceClient ur = new ServiceReference1.ActivosFijosServiceClient();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            Boolean result = await ur.IniciarSesionAsync(model.Usuario, model.Password);
            if (result)
            {
